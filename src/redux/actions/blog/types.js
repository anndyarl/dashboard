...
export const GET_AUTHOR_BLOG_LIST_PAGE_SUCCESS = 'GET_AUTHOR_BLOG_LIST_PAGE_SUCCESS';
export const GET_AUTHOR_BLOG_LIST_PAGE_FAIL = 'GET_AUTHOR_BLOG_LIST_PAGE_FAIL';