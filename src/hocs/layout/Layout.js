...
import yournalup_logo from 'assets/img/yournalup_logo.png'
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-white">
                ...
                <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
                  <button onClick={() => setOpen(true)} className="group block flex-shrink-0">
                    {/* Logo Mobile */}
          ...
          <div className="flex flex-shrink-0 border-t border-gray-200 p-4">
            <button onClick={() => setOpen(true)} className="group block w-full flex-shrink-0">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-700 group-hover:text-gray-900">Andy Riquelme</p>
